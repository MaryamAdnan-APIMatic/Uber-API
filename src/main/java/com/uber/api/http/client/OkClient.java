...
import com.uber.api.http.request.MultipartFileWrapper;
import com.uber.api.http.request.MultipartWrapper;
import com.uber.api.http.response.HttpResponse;
import com.uber.api.http.response.HttpStringResponse;
import com.uber.api.utilities.FileWrapper;
...
public class OkClient implements HttpClient {
     ...
     * @throws  IOException exception to be thrown while converting response.
     */
    private HttpResponse convertResponse(HttpRequest request, okhttp3.Response response,
